...
if __name__ == '__main__':
    slam = SLAMSystem()
    path_data = SLAMSystem.handleRequest(SLAMSystem, call=True)
    print(path_data)
    path_data = path_data.strip()  # Remove extra spaces
    ...
    frame_interval = int(fps*0.1)  # 0.2 seconds
